...
public class Test_4_2_22_NonMotor {
    // 私有属性：品牌、颜色、轮子(默认2个)、座椅（默认 1个）
	private String brand;//品牌
	private String color;//颜色
	private int wheel = 2;//轮子
	private int seat = 1;//座椅
	// 无参构造方法
	public Test_4_2_22_NonMotor() {
		
	}
	// 双参构造方法，完成对品牌和颜色的赋值
	public Test_4_2_22_NonMotor(String brand,String color) {
		this.setBrand(brand);
		this.setColor(color);
	}
	// 四参构造方法，分别对所有属性赋值
	public Test_4_2_22_NonMotor(String brand,String color,int wheel,int seat) {
		this.setBrand(brand);
		this.setColor(color);
		this.setWheel(wheel);
		this.setSeat(seat);
