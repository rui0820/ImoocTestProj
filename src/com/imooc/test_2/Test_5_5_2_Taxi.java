...
public class Test_5_5_2_Taxi extends Test_5_5_2_Car{
    //私有属性：所属公司( company)
	private String company;

	public Test_5_5_2_Taxi(){
		
	}
	//调用父类的构造方法，完成属性赋值
	public Test_5_5_2_Taxi(String color,String userName,String company){
	...
	final public String ride() {
		return this.getUserName() + "的出租车是所属于" + this.getCompany() + "公司的。";
	}
